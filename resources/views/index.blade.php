    ...
    <div id="marcosCarousel" class="carousel slide mb-4" data-bs-ride="carousel" style="max-width: 600px; width: 100%;">
        <div class="carousel-inner rounded shadow">
            <div class="carousel-item active">
                <img src="{{ asset('carrucel_img/carrusel1.jpg') }}" class="d-block w-100" alt="Imagen 1">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('carrucel_img/carrusel2.jpg') }}" class="d-block w-100" alt="Imagen 2">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('carrucel_img/carrusel3.jpg') }}" class="d-block w-100" alt="Imagen 3">
            </div>
        </div>
